...
export function buildSmokeCases(origins) {
  ...
  return [
    ...
    { id: "C-en-article", category: "C", severity: "BLOCK", url: `${www}/2026/08/how-to-download-youtube-thumbnail.html`, status: 200, expectHtml: true, noSpaShell: true, noBanned: true, canonicalIncludes: "https://www.11tik.com/how-to-download-youtube-thumbnail" },
    ...
    { id: "E-en-about-clean", category: "E", severity: "BLOCK", url: `${www}/about`, status: 200, expectHtml: true, noSpaShell: true, noBanned: true, canonicalIncludes: "https://www.11tik.com/about", securityHeaders: true },
    { id: "E-en-legacy-about-redirect", category: "E", severity: "BLOCK", url: `${www}/p/about.html`, status: 301, redirectManual: true, location: `${www}/about`, verifyFinal: { status: 200, canonicalIncludes: "https://www.11tik.com/about" } },
    ...
    { id: "N-fr-utility", category: "N", severity: "BLOCK", url: `${fr}/l/fr/p/about.html`, status: 200, expectHtml: true, lang: "fr", locale: "fr", noBanned: true, canonicalIncludes: "https://fr.11tik.com/l/fr/about" },
    { id: "O-fr-article", category: "O", severity: "BLOCK", url: `${fr}/l/fr/2026/08/how-to-download-youtube-thumbnail.html`, status: 200, expectHtml: true, lang: "fr", locale: "fr", h1Fr: true, noSpaShell: true, noBanned: true, canonicalIncludes: "https://fr.11tik.com/l/fr/how-to-download-youtube-thumbnail" },
    { id: "P-fr-utility-slash", category: "P", severity: "BLOCK", url: `${fr}/l/fr/p/about.html/`, status: 301, redirectManual: true, location: `${fr}/l/fr/about`, verifyFinal: { status: 200, canonicalIncludes: "/l/fr/about" }, workerHsts: true },
    { id: "P-fr-article-slash", category: "P", severity: "BLOCK", url: `${fr}/l/fr/2026/08/how-to-download-youtube-thumbnail.html/`, status: 301, redirectManual: true, location: `${fr}/l/fr/how-to-download-youtube-thumbnail`, verifyFinal: { status: 200, canonicalIncludes: "/l/fr/how-to-download-youtube-thumbnail" } },
    ...
    { id: "U-ar-utility-slash", category: "U", severity: "BLOCK", url: `${ar}/l/ar/p/about.html/`, status: 301, redirectManual: true, location: `${ar}/l/ar/about`, verifyFinal: { status: 200, canonicalIncludes: "/l/ar/about" } },
