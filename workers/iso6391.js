/** Official ISO 639-1 language codes for 11tik locale hosts. */
...
export const ISO6391_CODES = new Set(ISO6391.map(([code]) => code));
export const RTL_CODES = new Set(["ar", "dv", "fa", "he", "ps", "sd", "ur", "yi"]);

export function langName(code) {
  const row = ISO6391.find(([item]) => item === code);
